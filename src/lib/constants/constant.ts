...
export const KAKAO_GET_KAKAO_ACCESS_TOKEN_URL = "https://kauth.kakao.com/oauth/token";
export const KAKAO_LOGIN_REDIRECT_URL = WEB_URL + "/signup/kakao";
export const KAKAO_LOGIN_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_KAKAO_API_KEY}&redirect_uri=${KAKAO_LOGIN_REDIRECT_URL}&response_type=code`;
export const KAKAO_GET_KAKAO_ACCOUNT_URL = "https://kapi.kakao.com/v2/user/me";
